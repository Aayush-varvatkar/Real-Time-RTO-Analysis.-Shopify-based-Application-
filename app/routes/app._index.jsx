...
// ─── India RTO Map ──────────────────────────────────────────────────────────────
const INDIA_STATES = [
  { id: 'AN', name: 'Andaman and Nicobar Islands', d: 'M680,480 L685,475 L690,480 L688,490 L682,492 Z' },
  { id: 'AP', name: 'Andhra Pradesh', d: 'M380,370 L430,355 L470,360 L490,390 L475,430 L440,450 L400,440 L370,410 Z' },
  { id: 'AR', name: 'Arunachal Pradesh', d: 'M600,120 L650,110 L700,115 L710,140 L660,155 L610,150 Z' },
  { id: 'AS', name: 'Assam', d: 'M570,150 L610,145 L640,155 L635,180 L595,190 L560,180 L555,165 Z' },
  { id: 'BR', name: 'Bihar', d: 'M460,195 L510,188 L535,200 L530,235 L490,245 L455,235 L445,215 Z' },
  { id: 'CG', name: 'Chhattisgarh', d: 'M400,255 L450,245 L475,260 L480,310 L455,335 L415,330 L390,305 L385,270 Z' },
  { id: 'GA', name: 'Goa', d: 'M270,360 L285,355 L290,370 L278,378 L268,372 Z' },
  { id: 'GJ', name: 'Gujarat', d: 'M155,210 L210,195 L255,205 L265,240 L260,280 L235,295 L195,300 L165,285 L145,255 L148,225 Z' },
  { id: 'HR', name: 'Haryana', d: 'M270,145 L315,138 L335,155 L330,185 L295,192 L265,178 L258,158 Z' },
  { id: 'HP', name: 'Himachal Pradesh', d: 'M285,105 L330,98 L355,110 L350,140 L315,150 L282,138 L275,120 Z' },
  { id: 'JK', name: 'Jammu and Kashmir', d: 'M235,45 L285,35 L330,42 L345,75 L320,100 L285,108 L252,98 L228,72 Z' },
  { id: 'JH', name: 'Jharkhand', d: 'M470,220 L515,212 L535,228 L528,265 L495,275 L462,262 L452,238 Z' },
  { id: 'KA', name: 'Karnataka', d: 'M265,335 L320,318 L370,330 L385,370 L370,415 L335,435 L295,425 L265,395 L252,358 Z' },
  { id: 'KL', name: 'Kerala', d: 'M295,420 L320,412 L330,445 L322,490 L305,505 L288,492 L282,458 Z' },
  { id: 'LA', name: 'Ladakh', d: 'M248,42 L290,28 L340,30 L360,58 L340,80 L298,88 L258,78 Z' },
  { id: 'MP', name: 'Madhya Pradesh', d: 'M275,215 L340,202 L400,208 L430,228 L425,275 L395,295 L345,302 L295,290 L262,265 L255,235 Z' },
  { id: 'MH', name: 'Maharashtra', d: 'M210,270 L268,258 L310,270 L330,305 L310,358 L268,368 L225,355 L195,318 L188,285 Z' },
  { id: 'MN', name: 'Manipur', d: 'M638,182 L658,178 L665,198 L650,212 L632,208 L628,192 Z' },
  { id: 'ML', name: 'Meghalaya', d: 'M548,178 L585,172 L598,185 L588,200 L552,202 L540,190 Z' },
  { id: 'MZ', name: 'Mizoram', d: 'M620,210 L638,205 L645,225 L632,240 L615,235 L610,220 Z' },
  { id: 'NL', name: 'Nagaland', d: 'M645,158 L668,152 L678,168 L665,182 L645,178 L638,166 Z' },
  { id: 'OD', name: 'Odisha', d: 'M468,248 L515,238 L545,252 L548,295 L522,325 L485,330 L455,312 L448,272 Z' },
  { id: 'PY', name: 'Puducherry', d: 'M390,430 L398,427 L402,438 L394,442 Z' },
  { id: 'PB', name: 'Punjab', d: 'M248,128 L292,118 L320,130 L318,160 L285,168 L250,155 Z' },
  { id: 'RJ', name: 'Rajasthan', d: 'M168,130 L245,115 L290,128 L295,170 L280,215 L232,235 L185,228 L152,200 L142,162 Z' },
  { id: 'SK', name: 'Sikkim', d: 'M540,152 L555,148 L560,162 L548,168 L535,162 Z' },
  { id: 'TN', name: 'Tamil Nadu', d: 'M325,418 L368,408 L388,428 L382,475 L358,505 L330,515 L308,498 L302,462 L315,430 Z' },
  { id: 'TS', name: 'Telangana', d: 'M355,315 L400,305 L432,318 L435,358 L412,378 L375,372 L348,350 Z' },
  { id: 'TR', name: 'Tripura', d: 'M598,198 L615,192 L620,210 L608,220 L595,212 Z' },
  { id: 'UP', name: 'Uttar Pradesh', d: 'M295,155 L370,142 L428,148 L448,175 L440,215 L395,228 L335,232 L285,220 L262,195 L268,168 Z' },
  { id: 'UK', name: 'Uttarakhand', d: 'M318,128 L362,118 L390,130 L385,158 L348,168 L312,155 Z' },
  { id: 'WB', name: 'West Bengal', d: 'M515,185 L548,178 L562,192 L558,235 L535,252 L510,242 L498,215 L502,195 Z' },
  { id: 'DL', name: 'Delhi', d: 'M295,165 L308,160 L315,170 L305,180 L292,175 Z' },
  { id: 'CH', name: 'Chandigarh', d: 'M285,138 L294,135 L298,142 L290,146 Z' },
  { id: 'DN', name: 'Dadra and Nagar Haveli', d: 'M230,278 L238,275 L242,282 L235,288 Z' },
  { id: 'DD', name: 'Daman and Diu', d: 'M220,268 L228,265 L230,272 L222,275 Z' },
  { id: 'LD', name: 'Lakshadweep', d: 'M215,445 L220,442 L224,448 L218,452 Z' },
];

function getRtoColor(rtoPct, hasData) {
  if (!hasData) return '#e5e7eb';          // no data — light grey
  if (rtoPct === 0) return '#d1fae5';      // 0% — very light green
  if (rtoPct < 15) return '#6ee7b7';      // low — green
  if (rtoPct < 30) return '#fde68a';      // medium — yellow
  if (rtoPct < 50) return '#fb923c';      // high — orange
  return '#ef4444';                        // very high — red
}

function IndiaRTOMap({ statesData }) {
  const [tooltip, setTooltip] = useState(null); // { x, y, state }

  // Build a lookup: normalised state name -> data
  const stateMap = useMemo(() => {
    const map = {};
    statesData.forEach(s => {
      map[s.name.trim().toLowerCase()] = s;
    });
    return map;
  }, [statesData]);

  const getStateData = (stateName) => {
    return stateMap[stateName.trim().toLowerCase()] || null;
  };
  ...
  const tooltipData = tooltip ? getStateData(tooltip.stateName) : null;
  ...
  return (
    <div style={{ backgroundColor: '#fff', borderRadius: '12px', border: '1px solid #e5e7eb', overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
      ...
      <div style={{ padding: '14px 20px', borderBottom: '1px solid #f3f4f6', backgroundColor: '#fafafa', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <span style={{ fontSize: '15px', fontWeight: '700', color: '#111827' }}>🗺️ India RTO Heatmap</span>
        {/* Legend */}
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center', fontSize: '11px', color: '#6b7280' }}>
          {[
            { color: '#e5e7eb', label: 'No data' },
            { color: '#6ee7b7', label: 'Low (<15%)' },
            { color: '#fde68a', label: 'Medium (15–30%)' },
            { color: '#fb923c', label: 'High (30–50%)' },
            { color: '#ef4444', label: 'Critical (>50%)' },
          ].map(item => (
            <span key={item.label} style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
              <span style={{ width: '10px', height: '10px', borderRadius: '2px', backgroundColor: item.color, display: 'inline-block', border: '1px solid rgba(0,0,0,0.1)' }} />
              {item.label}
            </span>
          ))}
        </div>
      ...
      <div style={{ position: 'relative', padding: '16px' }}>
          ...
          {INDIA_STATES.map(state => {
            ...
            return (
              <path
                ...
                stroke="#fff"
                strokeWidth="1.5"
                style={{ cursor: 'pointer', transition: 'filter 0.15s ease, opacity 0.15s ease' }}
                onMouseMove={(e) => handleMouseMove(e, state.name)}
                onMouseLeave={handleMouseLeave}
                onMouseEnter={(e) => { e.currentTarget.style.filter = 'brightness(0.85)'; e.currentTarget.style.opacity = '0.9'; }}
                onMouseOut={(e) => { e.currentTarget.style.filter = 'none'; e.currentTarget.style.opacity = '1'; }}
              />
            );
          })}
        </svg>
        ...
        {tooltip && (
          <div style={{
            ...
            <div style={{ fontWeight: '700', fontSize: '13px', marginBottom: '6px', borderBottom: '1px solid rgba(255,255,255,0.15)', paddingBottom: '4px' }}>
              {tooltip.stateName}
            </div>
            {tooltipData ? (
              <>
                <div style={{ display: 'flex', justifyContent: 'space-between', gap: '16px', marginBottom: '3px' }}>
                  ...
                  <span style={{ fontWeight: '600' }}>{tooltipData.total}</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', gap: '16px', marginBottom: '3px' }}>
                  <span style={{ color: '#9ca3af' }}>Delivered</span>
                  <span style={{ fontWeight: '600', color: '#6ee7b7' }}>{tooltipData.delivered}</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', gap: '16px', marginBottom: '3px' }}>
                  <span style={{ color: '#9ca3af' }}>RTO</span>
                  <span style={{ fontWeight: '600', color: '#f87171' }}>{tooltipData.rto}</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', gap: '16px' }}>
                  <span style={{ color: '#9ca3af' }}>RTO %</span>
                  <span style={{ fontWeight: '700', color: tooltipData.rtoPct >= 30 ? '#f87171' : tooltipData.rtoPct >= 15 ? '#fbbf24' : '#6ee7b7' }}>
                    {tooltipData.rtoPct}%
                  </span>
                </div>
              </>
            ) : (
              <div style={{ color: '#9ca3af', fontSize: '11px' }}>No order data</div>
            )}
          </div>
        )}
      </div>
        ...
        <Page title="Dashboard" fullWidth>
          <BlockStack gap="400">
            ...
            <div style={{ marginTop: '8px' }}>
              ...
              {/* India Heatmap */}
              <IndiaRTOMap statesData={rtoAnalysis.states} />
